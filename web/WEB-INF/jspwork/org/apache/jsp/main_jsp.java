 ...
 * Generated at: 2019-04-23 10:31:17 UTC
...
public final class main_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/views/common/ufooter.jsp", Long.valueOf(1554369102143L));
    _jspx_dependants.put("/views/common/header.jsp", Long.valueOf(1556013790954L));
  }
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("$(function(){\r\n");
      out.write("\t $.ajax({\r\n");
      out.write("\t\t \turl : '/math/popup.do',\r\n");
      out.write("\t        type : 'post',\r\n");
      out.write("\t        dataType : 'json',\r\n");
      out.write("\t        success : function(data){\r\n");
      out.write("\t                var jsonStr = JSON.stringify(data);\r\n");
      out.write("\t\t\t\t\tvar json = JSON.parse(jsonStr);\r\n");
      out.write("\t\t\t\t\tfor( i in json.list){\r\n");
      out.write("\t\t\t\t\t\tvar sdate= new Date(json.list[i].startDate);\r\n");
      out.write("\t\t\t\t\t\tvar edate= new Date(json.list[i].endDate);\r\n");
      out.write("\t\t\t\t\t\tvar images = json.list[i].popupImagePath;\r\n");
      out.write("\t\t\t\t\t\tvar imglink = decodeURIComponent(json.list[i].popupImgLink);\r\n");
      out.write("\t\t\t\t\t\tvar now = new Date();\r\n");
      out.write("\t\t\t\t\t\tif(now >= sdate && now <= edate){\r\n");
      out.write("\t\t\t\t\t\tOpenPopup(json.list[i].popupLink+\"?images=\"+ images + \"&imglink=\" + imglink , decodeURIComponent(json.list[i].popupName) , json.list[i].popupWidth, json.list[i].popupHeight, json.list[i].popupX, json.list[i].popupY);\r\n");
      out.write("\t\t\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\t\t}\r\n");
      ...
      out.write("});\r\n");
      out.write("\r\n");
      out.write("function OpenPopup(link, name , width, height, left, top){\r\n");
      out.write("       var winPop;\r\n");
      out.write("       winPop = window.open(link ,'pop'+name, 'toolbar=yes,width='+width+',height='+height+',left='+left+',top='+top+',status=yes,scrollbars=no, resize=yes, toolbar=no, location=no' );\r\n");
      out.write("\t\t\r\n");
      out.write("   }\r\n");
      out.write("</script>\r\n");
      out.write("</head>\r\n");
 ...
 String userId = (String)session.getAttribute("userId"); 
      ...
      out.write("            <a href=\"/math/nuslist.do\" class=\"nav-link\" style=\"font-family: 'Do Hyeon', sans-serif; font-size:20pt;\">\r\n");
